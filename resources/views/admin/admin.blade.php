...
<div class="card">
    <div class="card-header d-flex justify-content-end align-items-center">
        ...
        >
            <i class="mdi mdi-plus-circle me-1"></i> New Admin
        </button>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-center">
                            <button
                                ...
                                data-route="{{ route("admin.admins.show", $item->id) }}"
                            >
...
@include("admin.modal.admin.add")
@include("admin.modal.admin.edit")
