...
@section("content")
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Capstone /</span> Edit Book</h4>
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="form-floating form-floating-outline">
                            <select
                              ...
                              required
                            >
                                <option value="{{ $book->user_id }}" data-avatar="{{ $book->user->avatar() }}">
                                    {{ $book->user->fullname }}
                                </option>
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md mb-md-0 mb-2">
                            <div class="form-check custom-option custom-option-icon">
                              <label class="form-check-label custom-option-content" for="pending">
                                <span class="custom-option-body">
                                  <i class="mdi mdi-book-clock"></i>
                                  <span class="custom-option-title">Pending</span>
                                  <small>The book needs to verify.</small>
                                </span>
                                <input id="pending" name="status" class="form-check-input" type="radio" value="1" @if ($book->isPending()) checked @endif/>
                              </label>
                            </div>
                        </div>
                        <div class="col-md mb-md-0 mb-2">
                            <div class="form-check custom-option custom-option-icon">
                              <label class="form-check-label custom-option-content" for="accepted">
                                <span class="custom-option-body">
                                  ...
                                  <small>The book is now viewable.</small>
                                </span>
                                <input id="accepted" name="status" class="form-check-input" type="radio" value="2" @if ($book->isAccepted()) checked @endif/>
                              </label>
                            </div>
                        </div>
                        <div class="col-md mb-md-0 mb-2">
                            <div class="form-check custom-option custom-option-icon">
                              <label class="form-check-label custom-option-content" for="rejected">
                                <span class="custom-option-body">
                                  ...
                                  <span class="custom-option-title">Rejected</span>
                                  <small>The book didn't passed the verification.</small>
                                </span>
...
@section("scripts")
    ...
    $(document).ready(function() {
        ...
        @superadmin
        $("select[name=college]").val('{{ $book->college_id }}').trigger("change");
        @endsuperadmin
