...
@section("content")
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Clients /</span> Students</h4>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        >
            <i class="mdi mdi-plus-circle me-1"></i> New Student
        </button>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-center">
                            <button
                                ...
                                data-route="{{ route("admin.students.show", $item->id) }}"
                            >
...
@include("admin.modal.student.add")
@include("admin.modal.student.edit")
