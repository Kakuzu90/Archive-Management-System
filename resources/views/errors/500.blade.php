...
<head>
    ...
    <title>
        Server Timeout | Capstone Project Hub
    </title>
    ...
    <div class="misc-wrapper">
        ...
        <div class="d-flex justify-content-center mt-5">
          ...
          <div class="d-flex flex-column align-items-center">
            <img
              src="{{ asset("assets/img/illustrations/misc-server-error-illustration.png") }}"
              alt="misc-server-error"
              class="img-fluid zindex-1"
              width="230" />
            <div>
              <a href="{{ route("index") }}" class="btn btn-primary text-center my-5">Back to home</a>
            </div>
          </div>
        </div>
    </div>
